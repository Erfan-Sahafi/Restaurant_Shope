  ...
  return (
    <div className="container overflow-x-hidden flex flex-col sm:flex-row items-center justify-between py-8">
      <div className="" data-aos="fade-left">
        ...
        <p
          className={`text-justify md:leading-6 dark:text-white md:text-[18px] ${
        ...
        <span
          className="flex items-center gap-2 justify-end text-orange-400 cursor-pointer md:hidden"
          onClick={() => SetShowFullText(!showFullText)}
        >
          {showFullText ? "مطالعه کمتر" : "مطالعه بیشتر"}
          <IoIosArrowDown
            className={`${
              showFullText && "rotate-180 ease-linear duration-150"
            }`}
          />
        </span>
      </div>
